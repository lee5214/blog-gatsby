	...
	return (
		<SvgIcon { ...props } viewBox={ '0 0 256 208' } className={style} style={ {fill : `${props.fill}` || '#D6D6D6'} }>
			<g>
				...
				<path d="M166.212.188L90.918 42.541 15.624.188.564 8.658l89.412 50.824L181.271 8.66 166.21.189z"
				      style={ {fill : `${props.fill}` || '#D6D6D6' }}/>
				<path d="M151.153 42.541v53.647l15.059 8.47V34.072l-15.06 8.47z" style={ {fill : `${props.fill}` || '#EFEFEF' }}/>
				<path
				...
				<path d="M165.27 189.365l75.295-42.353V94.306l15.059-8.47v70.588l-90.353 50.823v-17.882z"
				      style={ {fill : `${props.fill}` || '#949494' }}/>
				<path d="M255.624 85.835l-15.06 8.47-15.058-8.47 15.059-8.47 15.059 8.47z" style={ {fill : `${props.fill}` || '#D6D6D6' }}/>
				<path d="M240.565 77.365V59.482l15.059-8.47v17.882l-15.06 8.47z" style={ {fill : `${props.fill}` || '#949494' }}/>
				<path d="M240.565 59.482v17.883l-15.06-8.47V51.011l15.06 8.47z" style={ {fill : `${props.fill}` || '#EFEFEF' }}/>
